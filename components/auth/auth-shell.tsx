    ...
    <main className="min-h-screen bg-background text-foreground">
      <div className="mx-auto grid min-h-screen max-w-[1440px] lg:grid-cols-[minmax(360px,0.9fr)_minmax(520px,1.1fr)]">
        <aside className="relative hidden overflow-hidden border-r border-border bg-card p-10 lg:flex lg:flex-col lg:justify-between xl:p-14">
          ...
          <div className="relative">
            ...
            <div className="mt-28 max-w-sm">
              ...
              <p className="mt-6 text-base leading-7 text-muted-foreground">
                A focused workspace for pipeline visibility, revenue confidence,
          ...
          <div className="relative grid grid-cols-2 gap-3 text-xs text-muted-foreground">
            <div className="rounded-xl border border-border bg-background/60 p-4">
              ...
              <p className="mt-1">win rate lift</p>
            </div>
            <div className="rounded-xl border border-border bg-background/60 p-4">
              <p className="text-2xl font-semibold text-foreground">4.2x</p>
              <p className="mt-1">pipeline coverage</p>
            </div>
          </div>
        </aside>
        <section className="flex min-h-screen flex-col">
          ...
          <div className="flex flex-1 items-start justify-center px-6 pb-12 pt-10 sm:px-12 lg:items-center lg:px-20 lg:pb-20 lg:pt-0">
            {children}
          </div>
          <p className="px-6 pb-6 text-center text-xs text-muted-foreground sm:px-12 lg:px-20 lg:pb-8 lg:text-right">
